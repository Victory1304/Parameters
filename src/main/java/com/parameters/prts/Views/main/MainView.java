...
import com.parameters.prts.Views.*;
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/corgiswimflip.gif", "App logo"));
        logoLayout.add(new H1(new RouterLink("Показатели", AboutView.class)));
